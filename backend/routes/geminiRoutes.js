...
// // Choose your model. gemini-1.5-flash is good for speed, gemini-1.5-pro for more complex tasks.
...
//   try {
//     // --- Crucial: Prompt Engineering for Cost Estimation ---
//     const structuredPrompt = `
//       You are an expert AI cost estimator. Your goal is to provide a concise and direct cost estimate based on the user's input and comparission of the items along with the platform name and price.
//       Focus only on the numerical estimate (e.g., "$X,XXX", "₹X,XXX") and a very brief explanation of the factors influencing it.
//       If a precise number is not possible, provide a realistic range and state the reasons.
//       Avoid conversational greetings, apologies, or unrelated information.Give the cost in ₹ 
      
//       User Input:
//       ${prompt}

//       Examples of desired output format:
//       - Estimated Cost: $500 - $800. Varies by brand and specific features.
//       - Estimated Cost: ₹35,000. For a standard model, new condition.
//       - Estimated Cost: $1,500 - $2,500. Depends on complexity and hours of work.
//       - Estimated Cost: $120. Standard service charge, excluding parts.

//       Please provide the cost estimate in the format specified above.
//     `;
