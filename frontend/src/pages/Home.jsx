...
//         const response = await axios.get(`http://localhost:5000/api/recent-searches/${user._id}`);
...
//     fetchRecentSearches();
//   }, []); // Re-run this effect when the user object changes (e.g., after login)
...
//         <img className="w-20 h-20 md:w-20 md:h-20 object-contain" src="../public/logo.png" alt="Logo" />
//         </div>
...
//             ) : (
//               <div className="flex flex-wrap gap-4 justify-center"> {/* Added justify-center for better layout */}
    ...
    <div>
      <div className="bg-gray-900 text-white min-h-screen font-sans relative overflow-hidden">
        ...
        <nav className="flex justify-between items-center p-2 bg-transparent backdrop-blur-lg shadow-2xl fixed w-full top-0 left-0 z-50">
          ...
          <div className="relative">
            {/* <button onClick={toggleDropdown} className="text-xl">
              {/* Using placeholder image, replace with your actual profile icon path 
              <img src="/profile-icon.png" alt="Profile" className="w-16 h-16 rounded-full" />
            </button> */}
            <button onClick={toggleDropdown} className="text-xl">
