...
//   const { prompt, result } = location.state || {};

//   return (
//     <div className="min-h-screen bg-gray-100 px-6 py-10">
//       <div className="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-lg">
//         <h2 className="text-xl font-bold mb-4 text-gray-800">Search Result</h2>
//         <p className="text-sm mb-2 text-gray-600">Prompt Used:</p>
//         <div className="bg-gray-100 p-4 rounded text-sm mb-6">
//           {prompt}
//         </div>
//         <h3 className="text-sm font-semibold mb-2 text-gray-700">Gemini Response:</h3>
